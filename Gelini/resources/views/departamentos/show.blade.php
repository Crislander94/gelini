            ...
            <div class="col-md-15">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{ url('/departamentos/' . $departamento->id . '/edit') }}" title="Edit departamento"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
